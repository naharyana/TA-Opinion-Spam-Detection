...
for count in range (len(df3)) :
   print(count)
   if count%2==1 : #baris ganjil, data fitur di taruh di df2
...
df2 = df2.reset_index(drop=True) #data fitur produk
df3 = df3.reset_index(drop=True) #data produk
